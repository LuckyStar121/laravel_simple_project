        ...
        <div class="col-md-6">
            <div id="content-body">
                <div class="p-3 p-md-5">
                    <h5>Welcome to Olarm</h5>
                    <br />
                    <br />
                    <div class="">
                        <form name="form" action="{{ route('register') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Username" required>
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <button type="submit" class="btn btn-primary mb-4">{{ __('Register') }}</button>
